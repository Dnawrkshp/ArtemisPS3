...
int get_firmware_info()
{
	...
	switch(toc)
	{
		...
		case 0x800000000034FBB0ULL:
			...
			FIRMWARE = (lv2peek(0x80000000002FCB68ULL)==0x323031392F30312FULL) ? 0x484C : (lv2peek(0x80000000002FCB68ULL)==0x323031382F30392FULL) ? 0x483C : (lv2peek(0x80000000002FCB68ULL)==0x323031372F30382FULL) ? 0x482C : (lv2peek(0x80000000002FCB68ULL)==0x323031362F31302FULL) ? 0x481C : (lv2peek(0x80000000002FCB68ULL)==0x323031352F31322FULL) ? 0x478C : (lv2peek(0x80000000002FCB68ULL)==0x323031352F30382FULL) ? 0x476C : 0x475C;
			return SUCCESS;
		break;
		case 0x80000000003758E0ULL:
			...
			FIRMWARE = (lv2peek(0x800000000031EF48ULL)==0x323031352F31322FULL) ? 0x478D : (lv2peek(0x800000000031EF48ULL)==0x323031352F30382FULL) ? 0x476D : 0x475D;
			return SUCCESS;
		break;
		case 0x800000000034FBA0ULL:
			HV_START_OFFSET = HV_START_OFFSET_480;
			SYSCALL_TABLE = SYSCALL_TABLE_480;
			OFFSET_2_FIX = OFFSET_2_FIX_480;
			OFFSET_FIX = OFFSET_FIX_480;
			OFFSET_FIX_2B17 = OFFSET_FIX_2B17_480;
			OFFSET_FIX_LIC = OFFSET_FIX_LIC_480;
			OFFSET_FIX_3C = OFFSET_FIX_3C_480;
			OFFSET_FIX_17 = OFFSET_FIX_17_480;
			OFFSET_FIX_2B = OFFSET_FIX_2B_480;
			FIRMWARE = 0x480C;
			return SUCCESS;
		break;
		case 0x80000000003759B0ULL:
			...
			OFFSET_FIX_17 = OFFSET_FIX_17_480D;
			OFFSET_FIX_2B = OFFSET_FIX_2B_480D;
			FIRMWARE = 0x480D;
			return SUCCESS;
		break;
		case 0x800000000039D440ULL:
			HV_START_OFFSET = HV_START_OFFSET_480E;
			SYSCALL_TABLE = SYSCALL_TABLE_480E;
			OFFSET_2_FIX = OFFSET_2_FIX_480E;
			OFFSET_FIX = OFFSET_FIX_480E;
			OFFSET_FIX_2B17 = OFFSET_FIX_2B17_480E;
			OFFSET_FIX_LIC = OFFSET_FIX_LIC_480E;
			OFFSET_FIX_3C = OFFSET_FIX_3C_480E;
			OFFSET_FIX_17 = OFFSET_FIX_17_480E;
			OFFSET_FIX_2B = OFFSET_FIX_2B_480E;
			FIRMWARE = (lv2peek(0x8000000000344B70ULL)==0x323031392F30312FULL) ? 0x484E : (lv2peek(0x8000000000344B70ULL)==0x323031382F30392FULL) ? 0x483E : (lv2peek(0x8000000000344B70ULL)==0x323031372F30392FULL) ? 0x482E : (lv2peek(0x8000000000344B70ULL)==0x323031362F31302FULL) ? 0x481E : (lv2peek(0x8000000000344B70ULL)==0x323031352F31322FULL) ? 0x478E : (lv2peek(0x8000000000344B70ULL)==0x323031352F30382FULL) ? 0x476E : 0x475E;
			return SUCCESS;
		break;
		case 0x80000000003759C0ULL:
			...
			OFFSET_FIX_17 = OFFSET_FIX_17_481D;
			OFFSET_FIX_2B = OFFSET_FIX_2B_481D;
			FIRMWARE = (lv2peek(0x800000000031F028ULL)==0x323031392F30312FULL) ? 0x484D : (lv2peek(0x800000000031F028ULL)==0x323031382F30392FULL) ? 0x483D : (lv2peek(0x800000000031F028ULL)==0x323031372F30382FULL) ? 0x482D : 0x481D;
			return SUCCESS;
		break;
		default:
			return FAILED;
